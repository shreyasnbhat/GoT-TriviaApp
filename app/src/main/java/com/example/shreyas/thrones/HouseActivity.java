...
public class HouseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String temp = getIntent().getStringExtra("HousePosition");final int loc = Integer.parseInt(temp);
       ...
       getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        adapter = new ArrayAdapter<>(this,R.layout.list_item_main,R.id.house_names
                , sworn);
