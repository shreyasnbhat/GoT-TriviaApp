...
public class HouseFormat {
    ...
    public HouseFormat(String houseId,String name, String region, String coatOfArms, String words, ArrayList<String> titles, String currentLord, ArrayList<String> members) {
